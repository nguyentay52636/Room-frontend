...
import { Bed, Badge, Building, Edit, Eye, MapPin, Star, Bath, User, Trash2, Calendar, Square, MoreHorizontal } from 'lucide-react'
import { Button } from '@/components/ui/button'
import { DropdownMenu, DropdownMenuItem, DropdownMenuContent, DropdownMenuTrigger } from '@/components/ui/dropdown-menu'

export default function ListViewItem({ paginatedProperties, getStatusBadge, getTypeLabel, handleViewProperty, handleEditProperty, handleDeleteProperty }: any) {
  return (
