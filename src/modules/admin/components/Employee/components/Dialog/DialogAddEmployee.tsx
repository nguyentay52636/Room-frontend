...
import { User, Mail, Phone, Calendar, Upload, Briefcase, MapPin, FileText, DollarSign, Building, X } from "lucide-react"
...
export function DialogAddEmployee({ open, onOpenChange, staff, mode }: StaffDialogProps) {
    ...
    const getDialogDescription = () => {
        switch (mode) {
            case "add":
                return "Thêm nhân viên mới"
            case "edit":
                return "Cập nhật thông tin nhân viên"
            case "view":
                return "Xem chi tiết thông tin nhân viên"
            default:
                return ""
        }
    }
                        ...
                        <div className="flex flex-col items-center space-y-4">
                            ...
                            {!isReadOnly && (
                                <Button
                                    variant="outline"
                                    size="sm"
                                    className="text-sm font-medium hover:bg-blue-50 dark:hover:bg-blue-900/20 border-gray-200 dark:border-gray-700 bg-transparent"
                                >
                                    ...
                                    <div className="space-y-2">
                                        ...
                                        <div className="relative">
                                            ...
                                            <Input
                                                ...
                                                className={`pl-10 h-11 border-gray-200 dark:border-gray-700 focus:border-blue-500 dark:focus:border-blue-400 ${errors.name ? "border-red-500 focus:border-red-500" : ""
                                                    }`}
                                                disabled={isReadOnly}
                                            />
                                    ...
                                    <div className="space-y-2">
                                        ...
                                        <div className="relative">
                                            ...
                                            <Input
                                                ...
                                                className={`pl-10 h-11 border-gray-200 dark:border-gray-700 focus:border-blue-500 dark:focus:border-blue-400 ${errors.email ? "border-red-500 focus:border-red-500" : ""
                                                    }`}
                                                disabled={isReadOnly}
                                            />
                                    ...
                                    <div className="space-y-2">
                                        ...
                                        <div className="relative">
                                            ...
                                            <Input
                                                ...
                                                className={`pl-10 h-11 border-gray-200 dark:border-gray-700 focus:border-blue-500 dark:focus:border-blue-400 ${errors.phone ? "border-red-500 focus:border-red-500" : ""
                                                    }`}
                                                disabled={isReadOnly}
                                            />
                                    ...
                                    <div className="space-y-2">
                                        ...
                                        <div className="relative">
                                            ...
                                            <Input
                                                ...
                                                className={`pl-10 h-11 border-gray-200 dark:border-gray-700 focus:border-blue-500 dark:focus:border-blue-400 ${errors.salary ? "border-red-500 focus:border-red-500" : ""
                                                    }`}
                                                disabled={isReadOnly}
                                            />
                                    ...
                                    <div className="space-y-2">
                                        ...
                                        <div className="relative">
                                            ...
                                            <Select
                                                ...
                                                disabled={isReadOnly}
                                            >
                                                <SelectTrigger className="pl-10 h-11 border-gray-200 dark:border-gray-700 focus:border-blue-500 dark:focus:border-blue-400">
                ...
                <DialogFooter className="px-6 py-2 border-t border-gray-100 dark:border-gray-800 bg-gray-50 dark:bg-gray-800/50">
                    <div className="flex justify-end space-x-2 w-full ">
                        <Button
                            ...
                            className="px-3 h-10 border-gray-200 dark:border-gray-700 hover:bg-gray-100 dark:hover:bg-gray-700"
                        >
                            {mode === "view" ? "Đóng" : "Hủy"}
                        </Button>
                        {mode !== "view" && (
                            <Button
                                ...
                                className="px-4 h-10 bg-blue-600 hover:bg-blue-700 text-white font-medium shadow-sm"
                            >
